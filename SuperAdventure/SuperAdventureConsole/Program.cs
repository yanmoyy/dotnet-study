        ...
        private static void ParseInput(string input)
        {
            ...
            else if (input.StartsWith("equip "))
            {
                ...
                else
                {
                    Weapon weaponToEquip = _player.Weapons.SingleOrDefault(x =>
                        x.Name.ToLower() == inputWeaponName
            ...
            else if (input.StartsWith("drink "))
            {
                ...
                else
                {
                    HealingPotion potionToDrink = _player.Potions.SingleOrDefault(x =>
                        x.Name.ToLower() == inputPotionName
                        || x.NamePlural.ToLower() == inputPotionName
                    );
            ...
            else if (input == "trade")
            {
                ...
                else
                {
                    ...
                    {
                        foreach (
                            InventoryItem inventoryItem in _player.Inventory.Where(x =>
                    ...
                    {
                        foreach (
                            InventoryItem inventoryItem in _player
                                .CurrentLocation
                                .VendorWorkingHere
                                .Inventory
                        )
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                Console.WriteLine(
                                    "You bought one {0} for {1} gold",
                                    itemToBuy.Details.Name,
                                    itemToBuy.Price
                                );
                            }
                        }
