...
namespace Engine
{
    public static class World
    {
        ...
        {
            Items.Add(new Weapon(ITEM_ID_RUSTY_SWORD, "Runsty sword", "Rusty swords", 0, 5));
            ...
            Items.Add(
                new HealingPotion(ITEM_ID_HEALING_POTION, "Healing potion", "Healing potions", 5)
            );
        ...
        private static void PopulateLocations()
        {
            ...
            Location home = new Location(
                LOCATION_ID_HOME,
                "Home",
                "Your house. You really need to clean up this place."
            );
