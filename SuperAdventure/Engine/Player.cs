    ...
    public class Player : LivingCreature
    {
        ...
        public void MoveTo(Location location)
        {
            if (PlayerDoesNotHaveTheRequiredItemToEnter(location))
            {
                RaiseMessage(
                    "You must have a "
                        + location.ItemRequiredToEnter.Name
        ...
        {
            int damage = RandomNumberGenerator.NumberBetween(
        ...
        private void LootTheCurrentMonster()
        {
            ...
            RaiseMessage(
                "You receive " + _currentMonster.RewardExperiencePoints + " experience points"
            );
        ...
        {
            InventoryItem existingItemInInventory = Inventory.SingleOrDefault(ii =>
                ii.Details.ID == itemToAdd.ID
            );
        ...
        {
            // Popultate the current monster with this location's monster (or null, if there is no monster here)
        ...
        {
            RaiseMessage("You receive thea" + quest.Name + " quest.");
        ...
        private void CreateNewChildXmlNode(
        ...
        private void AddXmlAttributeToNode(
            XmlDocument document,
            XmlNode node,
