...
namespace Engine
{
    public static class PlayerDataMapper
    {
        private static readonly string _connectionString =
            "Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=SuperAdventure;Integrated Security=True";
        ...
        public static Player CreateFromDatabase()
        {
                        ...
                        if (reader.HasRows)
                        {
                            while (reader.Read())
                            {
                                ...
                                player.AddItemToInventory(
                                    World.ItemByID(inventoryItemID),
                                    quantity
                                );
                            }
                        }
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine("CreateFromDatabase: " + ex.Message);
            }
        ...
        public static void SaveToDatabase(Player player)
        {
                ...
                using (SqlConnection connection = new SqlConnection(_connectionString))
                {
                    ...
                    using (SqlCommand existingRowCountCommand = connection.CreateCommand())
                    {
                        ...
                        if (existingRowCount == 0)
                        {
                            ...
                            using (SqlCommand insertSavedGame = connection.CreateCommand())
                            {
                                ...
                                insertSavedGame.Parameters["@CurrentLocationID"].Value = player
                                    .CurrentLocation
                                    .ID;
                        ...
                        else
                        {
                            ...
                            using (SqlCommand updateSavedGame = connection.CreateCommand())
                            {
                                ...
                                updateSavedGame.Parameters["@CurrentLocationID"].Value = player
                                    .CurrentLocation
                                    .ID;
                    ...
                    foreach (PlayerQuest playerQuest in player.Quests)
                    {
                        using (SqlCommand insertQuestCommand = connection.CreateCommand())
                        {
                            ...
                            insertQuestCommand.Parameters["@QuestID"].Value = playerQuest
                                .Details
                                .ID;
                    ...
                    foreach (InventoryItem inventoryItem in player.Inventory)
                    {
                        using (SqlCommand insertInventoryCommand = connection.CreateCommand())
                        {
                            ...
                            insertInventoryCommand.Parameters["@InventoryItemID"].Value =
                                inventoryItem.Details.ID;
                    ...
                    foreach (int locationVisitedID in player.LocationsVisited)
                    {
                        using (SqlCommand insertLocationVisitedCommand = connection.CreateCommand())
                        {
                            ...
                            insertLocationVisitedCommand.CommandText =
                                "INSERT INTO LocationVisited (ID) VALUES (@ID)";

                            insertLocationVisitedCommand.Parameters.Add("@ID", SqlDbType.Int);
                            insertLocationVisitedCommand.Parameters["@ID"].Value =
                                locationVisitedID;
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine("SaveToDatabase: " + ex.Message);
            }
        }
    }
}
