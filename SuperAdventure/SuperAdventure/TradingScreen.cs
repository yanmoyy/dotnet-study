...
namespace SuperAdventure
{
    public partial class TradingScreen : Form
    {
        ...
        public TradingScreen(Player player)
        {
            ...
            dgvMyItems.Columns.Add(
                new DataGridViewTextBoxColumn { DataPropertyName = "ItemID", Visible = false }
            );
        ...
        private void dgvVendorItems_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.ColumnIndex == 3)
            {
                ...
                {
                    MessageBox.Show(
                        "You do not have enough gold to buy the " + itemBeingBought.Name
                    );
                }
            }
        }
