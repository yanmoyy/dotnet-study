...
namespace SuperAdventure
{
    public partial class SuperAdventure : Form
    {
        ...
        public SuperAdventure()
        {
            ...
            if (File.Exists(PLAYTER_DATA_FILE_NAME))
            {
                _player = Player.CreatePlayerFromXmlString(
                    File.ReadAllText(PLAYTER_DATA_FILE_NAME)
                );
            }
            else
            {
        ...
        private void MoveTo(Location newLocation)
        {
            ...
            if (newLocation.QuestAvailableHere != null)
            {
                ...
                bool playerAlreadyCompletedQuest = _player.CompletedThisQuest(
                ...
                if (playerAlreadyHasQuest)
                {
                    ...
                    if (!playerAlreadyCompletedQuest)
                    {
                        ...
                        if (playerHasAllItemsToCompleteQuest)
                        {
                            ...
                            _player.ExperiencePoints += newLocation
                                .QuestAvailableHere
            ...
            {
                rtbMessages.Text +=
                    "You see a " + newLocation.MonsterLivingHere.Name + Environment.NewLine;
            ...
            foreach (InventoryItem inventoryItem in _player.Inventory)
            {
                if (inventoryItem.Quantity > 0)
                {
                    dgvInventory.Rows.Add(
                        new[] { inventoryItem.Details.Name, inventoryItem.Quantity.ToString() }
                    );
                }
            }
        }
        ...
        private void UpdateQuestListInUI()
        {
            ...
            {
                dgvQuests.Rows.Add(
                    new[] { playerQuest.Details.Name, playerQuest.IsCompleted.ToString() }
                );
            }
        }
        ...
        private void btnUseWeapon_Click(object sender, EventArgs e)
        {
            ...
            if (_currentMonster.CurrentHitPoints <= 0)
            {
                ...
                rtbMessages.Text += Environment.NewLine;
                rtbMessages.Text +=
                    "You defeated the " + _currentMonster.Name + Environment.NewLine;
            ...
            else
            {
                ...
                if (_player.CurrentHitPoints <= 0)
                {
                    // Display message
                    rtbMessages.Text +=
                        "The " + _currentMonster.Name + " killed you." + Environment.NewLine;
