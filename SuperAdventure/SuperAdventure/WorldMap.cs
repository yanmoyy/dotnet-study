...
namespace SuperAdventure
{
    public partial class WorldMap : Form
    {
        ...
        public WorldMap(Player player)
        {
            ...
            SetImage(
                pic_0_2,
                player.LocationsVisited.Contains(5) ? "HerbalistsGarden" : "FogLocation"
            );
            SetImage(
                pic_1_2,
                player.LocationsVisited.Contains(4) ? "HerbalistsHut" : "FogLocation"
            );
        ...
        {
            using (
                Stream resourceStream = _thisAssembly.GetManifestResourceStream(
